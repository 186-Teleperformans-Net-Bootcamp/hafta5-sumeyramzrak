        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Person1 = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Person2 = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MessageSendTypes", x => x.SendTypeID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MessageTypes", x => x.TypeID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Messages_MessageSendTypes_SendType",
                        column: x => x.SendType,
                        principalTable: "MessageSendTypes",
                        principalColumn: "SendTypeID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Messages_MessageTypes_MType",
                        column: x => x.MType,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_GroupMember_GroupMemberID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Messages_MType",
                table: "Messages",
                column: "MType");

            migrationBuilder.CreateIndex(
                name: "IX_Messages_SendType",
                table: "Messages",
                column: "SendType");
